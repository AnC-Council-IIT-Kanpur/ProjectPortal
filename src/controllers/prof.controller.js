...
const checkHealth = asyncHandler(async (req, res) => {
    return res.status(200)
        .send(new ApiResponse(200, { "Prof route status": "Healthy" }, "Prof route is working fine"));
...
const login = asyncHandler(async (req, res) => {
    ...
    if (!errors.isEmpty()) {
        return res.status(400).send(new ApiResponse(400, errors.array(), "Validation error, empty fields"));
    }
